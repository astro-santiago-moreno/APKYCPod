...
SWIFT_CLASS("_TtC14IncdOnboarding8BaseCell")
...
SWIFT_CLASS("_TtC14IncdOnboarding16DecimalFormatter")
...
SWIFT_CLASS("_TtC14IncdOnboarding18FormViewController")
...
@interface FormViewController (SWIFT_EXTENSION(IncdOnboarding)) <UIScrollViewDelegate>
- (void)scrollViewWillBeginDragging:(UIScrollView * _Nonnull)scrollView;
@end


@interface FormViewController (SWIFT_EXTENSION(IncdOnboarding))
...
@interface FormViewController (SWIFT_EXTENSION(IncdOnboarding)) <UITableViewDataSource>
...
@interface FormViewController (SWIFT_EXTENSION(IncdOnboarding)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC14IncdOnboarding21IncdActivityIndicator")
...
SWIFT_CLASS("_TtC14IncdOnboarding14IncdCameraView")
@interface IncdCameraView : UIView
@property (nonatomic, weak) IBOutlet PreviewView * _Null_unspecified cameraView;
...
SWIFT_CLASS("_TtC14IncdOnboarding23IncdCameraViewLandscape")
@interface IncdCameraViewLandscape : IncdCameraView
@end


/// A checkbox based on UIButton.
/// Configure it the same way as UIButton (usually inside a storybaord).
/// <ul>
///   <li>
///     Set images using: <code>setImage(_, for:)</code>, where the <code>.normal</code> state referes to a
///     unchecked checkbox, and the <code>.selected</code> state refers to a checked checkbox.
///   </li>
///   <li>
///     Hook up using a target-action with the <code>valueChanged</code> event.
///   </li>
///   <li>
///     Get the state of the checkbox (checked/unchecked) using the <code>isSelected</code> property.
///   </li>
/// </ul>
SWIFT_CLASS("_TtC14IncdOnboarding12IncdCheckbox")
@interface IncdCheckbox : UIButton
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC14IncdOnboarding37IncdFaceDetectionConfigViewController")
@interface IncdFaceDetectionConfigViewController : FormViewController
- (void)viewDidLoad;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14IncdOnboarding16IncdFaceDetector")
@interface IncdFaceDetector : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface IncdFaceDetector (SWIFT_EXTENSION(IncdOnboarding)) <AVCaptureVideoDataOutputSampleBufferDelegate>
...
SWIFT_CLASS("_TtC14IncdOnboarding17IncdNumericKeypad")
...
SWIFT_CLASS("_TtC14IncdOnboarding23NavigationAccessoryView")
...
SWIFT_CLASS("_TtC14IncdOnboarding11PreviewView")
...
SWIFT_CLASS("_TtC14IncdOnboarding18RPCircularProgress")
...
@interface RPCircularProgress (SWIFT_EXTENSION(IncdOnboarding)) <CAAnimationDelegate>
